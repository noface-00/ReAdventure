...
public class MyTextField extends JTextField {
    ...
    public void setPrefixIcon(Icon prefixIcon) {
        ...
        initBorder(); // Llama a un método para ajustar el borde del campo de texto
    }
    ...
    // Método para pintar el texto de sugerencia si el campo está vacío
    @Override
    public void paint(Graphics g) {
        super.paint(g); // Llama al método de la clase base para pintar el componente

        if (getText().isEmpty()) { // Verifica si el campo de texto está vacío
    ...
    // Método privado para inicializar el borde del campo de texto
